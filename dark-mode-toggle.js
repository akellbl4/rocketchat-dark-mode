...
function toggleDarkMode() {
	// Cycle through modes
	const nextMode =
		DARK_MODE_MODES[(DARK_MODE_MODES.indexOf(getDarkModeSetting()) + 1) % DARK_MODE_MODES.length];
...
function addDarkModeToggle() {
	const sidebarFooter = $('.sidebar footer').first();

	sidebarFooter.addClass('sidebar--custom-colors');
	sidebarFooter.addClass('sidebar--footer')
	...
	darkModeButton = $(toggleButton).appendTo(sidebarFooter);
